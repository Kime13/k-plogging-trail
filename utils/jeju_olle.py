HIGHLIGHT_COORDS = {
    ...
    # 올레 14코스
    "Wollyeong Cactus Field": [33.3778, 126.2152],
    "Geumneung Beach": [33.3904, 126.2359],
    "Ongpo Port": [33.4045, 126.2503],
    # 올레 21코스
    "Byeolbangjin Fortress": [33.5268, 126.8829],
    "Hado Beach": [33.5131, 126.8992],
...
JEJU_OLLE_COURSES = [
    ...
    },
    {
        ...
        "start": "저지예술정보화마을", "end": "한림항",
        "start_en": "Jeoji Arts Village", "end_en": "Hallim Port",
        "distance_km": 19.9, "difficulty": "Challenge", "duration_hours": 6,
        "lat": 33.3308, "lon": 126.2502,
        "theme": "coastal",
        "highlights_en": ["Wollyeong Cactus Field", "Geumneung Beach", "Ongpo Port"],
        "description_en": "A diverse trail through forest paths, cactus fields and coastal scenery. Pass the unique Wollyeong Cactus Field — Korea's only wild cactus habitat — before reaching the stunning turquoise waters of Geumneung Beach.",
        "pet_friendly": True,
        "plogging_tip": "Long coastal route — bring plenty of bags for marine debris along the beach sections!",
