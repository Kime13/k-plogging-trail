SEOUL_COURSES = [
    ...
    },
    {
        ...
        "start": "북한산 정릉탐방센터", "end": "성북천",
        "start_en": "Bukhansan Jeongneung Visitor Center", "end_en": "Seongbuk Stream",
        "distance_km": 7.8, "difficulty": "Moderate", "duration_hours": 3,
        "lat": 37.6188, "lon": 126.9968,
        "theme": "mountain",
        "highlights_en": ["Bukhansan Jeongneung", "Bogungmun Gate", "Seongbuk Stream"],
        "description_en": "Explore the historic Seongbuk district through Bukhansan National Park's scenic trails. This culturally rich route connects ancient fortress walls to the charming Seongbuk Stream valley.",
        "pet_friendly": False,
        "plogging_tip": "Historic fortress area — keep this UNESCO-listed site pristine by collecting every piece of litter!",
        "official_map_url": "https://map.seoul.go.kr/smgis2/short/6OXH2",
        "kakao_map_url": "",
    },
    {
        "id": "seoul_4",
...
SEOUL_HIGHLIGHT_COORDS = {
    ...
    # 19코스 북한산 성북
    "Bukhansan Jeongneung": [37.6188, 126.9968],
    "Bogungmun Gate": [37.6121, 127.0083],
    "Seongbuk Stream": [37.5896, 127.0109],
    # 15코스 노을·하늘공원
